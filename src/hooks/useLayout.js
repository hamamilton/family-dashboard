...
const DEFAULT_LAYOUT = {
    xxl: [
        { i: 'chores', x: 0, y: 0, w: 16, h: 1 },
        { i: 'calendar', x: 16, y: 0, w: 8, h: 2 },
        { i: 'gospel', x: 0, y: 1, w: 8, h: 1 },
        { i: 'quest', x: 8, y: 1, w: 8, h: 1 },
        { i: 'meals', x: 0, y: 2, w: 8, h: 1 },
        { i: 'groceries', x: 8, y: 2, w: 8, h: 1 },
        { i: 'photos', x: 16, y: 2, w: 8, h: 2 },
    ],
    xl: [
        { i: 'chores', x: 0, y: 0, w: 10, h: 1 },
        { i: 'calendar', x: 10, y: 0, w: 6, h: 2 },
        { i: 'gospel', x: 0, y: 1, w: 5, h: 1 },
        { i: 'quest', x: 5, y: 1, w: 5, h: 1 },
        { i: 'meals', x: 0, y: 2, w: 5, h: 1 },
        { i: 'groceries', x: 5, y: 2, w: 5, h: 1 },
        { i: 'photos', x: 10, y: 2, w: 6, h: 2 },
    ],
    lg: [
        { i: 'chores', x: 0, y: 0, w: 8, h: 1 },
        { i: 'calendar', x: 8, y: 0, w: 4, h: 2 },
        { i: 'gospel', x: 0, y: 1, w: 4, h: 1 },
        { i: 'quest', x: 4, y: 1, w: 4, h: 1 },
        { i: 'meals', x: 0, y: 2, w: 4, h: 1 },
        { i: 'groceries', x: 4, y: 2, w: 4, h: 1 },
        { i: 'photos', x: 8, y: 2, w: 4, h: 2 },
    ],
    md: [
        { i: 'chores', x: 0, y: 0, w: 10, h: 1 },
        { i: 'calendar', x: 0, y: 1, w: 10, h: 2 },
        { i: 'gospel', x: 0, y: 3, w: 5, h: 1 },
        { i: 'quest', x: 5, y: 3, w: 5, h: 1 },
        { i: 'meals', x: 0, y: 4, w: 5, h: 1 },
        { i: 'groceries', x: 5, y: 4, w: 5, h: 1 },
        { i: 'photos', x: 0, y: 5, w: 10, h: 2 },
    ],
    sm: [
        { i: 'chores', x: 0, y: 0, w: 6, h: 1 },
        { i: 'calendar', x: 0, y: 1, w: 6, h: 2 },
        { i: 'gospel', x: 0, y: 3, w: 6, h: 1 },
        { i: 'quest', x: 0, y: 4, w: 6, h: 1 },
        { i: 'meals', x: 0, y: 5, w: 6, h: 1 },
        { i: 'groceries', x: 0, y: 6, w: 6, h: 1 },
        { i: 'photos', x: 0, y: 7, w: 6, h: 2 },
    ]
};
