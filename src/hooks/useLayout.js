...
const DEFAULT_LAYOUT = {
    ...
    sm: [
        ...
        { i: 'meals', x: 0, y: 4, w: 6, h: 1 },
        { i: 'groceries', x: 0, y: 5, w: 6, h: 1 },
        { i: 'photos', x: 0, y: 6, w: 6, h: 2 },
    ]
};
    ...
    if (localData) {
        try {
            ...
            if (!parsed.lg.find(item => item.i === 'photos')) {
                ...
                parsed.md.push({ i: 'photos', x: 0, y: 5, w: 10, h: 2 });
                parsed.sm.push({ i: 'photos', x: 0, y: 6, w: 6, h: 2 });
                localStorage.setItem('family_dashboard_layout', JSON.stringify(parsed));
            }
            return parsed;
        } catch (e) {
